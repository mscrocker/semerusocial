...
public class ITImageService {
	...
	public void testAddImageWithInstanceNotFoundException() {
		UserImpl user = createUser("userAddImgNotFoundException", "passAddImgNotFoundException",
				getDateTime(1, 1, 2000), "hombre", "coruna");
	...
	public void testGetImagesById() throws InstanceNotFoundException, ItsNotYourImageException {
		...
		List<ImageImpl> imageList = new ArrayList<>();
		...
		List<ImageImpl> imageList2 = new ArrayList<>();
	...
	public void testGetImageById() throws InstanceNotFoundException, ItsNotYourImageException {
		...
		BlockImageByUserId<ImageImpl> imageResult1 = imageService.getImageByUserId(imageCreated1.getImageId(),
				user.getId());
		BlockImageByUserId<ImageImpl> imageResult2 = imageService.getImageByUserId(imageCreated2.getImageId(),
				user.getId());
		BlockImageByUserId<ImageImpl> imageResult3 = imageService.getImageByUserId(imageCreated3.getImageId(),
				user.getId());
