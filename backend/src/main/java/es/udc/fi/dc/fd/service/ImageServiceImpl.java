...
public class ImageServiceImpl implements ImageService {
  ...
  @Override
  public void removeImage(Long imageId, Long userId) throws InstanceNotFoundException,
      ItsNotYourImageException {
  ...
  public Block<ImageImpl> getImagesByUserId(Long userId, int page)
    ...
    final Slice<ImageImpl> images = getImageRepository().findByUserId(userId, PageRequest.of(page,
        10));
  ...
  public Block<ImageImpl> getAnonymousCarrusel(String city, int page) {
    final Slice<ImageImpl> images = getImageRepository().findAnonymousCarrusel(city, page,
        10);
